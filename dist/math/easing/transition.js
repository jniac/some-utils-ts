...
export const out4 = (x) => 1 - (x = clamp01(1 - x)) * x * x * x;
export const out5 = (x) => 1 - (x = clamp01(1 - x)) * x * x * x * x;
export const out6 = (x) => 1 - (x = clamp01(1 - x)) * x * x * x * x * x;
/**
 ...
 */
export const inLinearOut = (x, p, q, s) => {
    const EPSILON = 1e-6;
...
export const asymmetricalInOut = (x, a, b) => {
