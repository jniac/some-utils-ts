...
export function bezier2(points, t, out) {
    out ??= { x: 0, y: 0 };
...
export function bezier3(points, t, out) {
    out ??= { x: 0, y: 0, z: 0 };
    switch (points.length) {
        case 3: {
            const [p0, p1, p2] = points;
 ...
 */
export function cubicBezierArcControlPoints(center, radius, start, end, tension = 1, out) {
    out ??= [
        { x: 0, y: 0 },
        { x: 0, y: 0 },
        { x: 0, y: 0 },
